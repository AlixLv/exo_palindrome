...
// methode getDate() retourne le jour du mois de la date indiquée
// methode setDate() permet de changer le jour du mois
...
function getNextPalindromes(x) {
	...
	while (x > 0) {
		...
		// insertion dynamique de variable dans la string date
